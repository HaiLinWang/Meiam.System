...
namespace Meiam.System.Interfaces
{
    public class BaseProductProcessService : BaseService<Base_ProductProcess>, IBaseProductProcessService
    {
        ...
        /// <param name="parm"></param>
        /// <returns></returns>
        public async Task< PagedInfo<ProductProcessVM>> QueryProcessPagesAsync(ProductProcessQueryDto parm)
        {
            var source = Db.Queryable<Base_ProductProcess, Sys_DataRelation, Base_WorkShop, Sys_DataRelation, Base_Factory>((a, b, c, d, e) => new object[] {
                JoinType.Inner,a.ID == b.Form,
                JoinType.Inner,b.To == c.ID,
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public async Task< ProductProcessVM> GetProcessAsync(string id)
        {
            var source = Db.Queryable<Base_ProductProcess, Sys_DataRelation, Base_WorkShop, Sys_DataRelation, Base_Factory>((a, b, c, d, e) => new object[] {
                JoinType.Inner,a.ID == b.Form,
                JoinType.Inner,b.To == c.ID,
        ...
        /// </summary>
        /// <returns></returns>
        public async Task< List<ProductProcessVM>> GetAllProcessAsync(bool? enable = null)
        {
            var source = Db.Queryable<Base_ProductProcess, Sys_DataRelation, Base_WorkShop, Sys_DataRelation, Base_Factory>((a, b, c, d, e) => new object[] {
                JoinType.Inner,a.ID == b.Form,
                JoinType.Inner,b.To == c.ID,
        ...
        /// <param name="workshopId"></param>
        /// <returns></returns>
        public async Task< bool> AnyAsync(string Id, string processNo, string workshopId)
        {
            return await Db.Queryable<Base_ProductProcess, Sys_DataRelation>((a, b) => new object[] {
                JoinType.Inner,a.ID == b.Form
            })
            .Where((a, b) => a.ID != Id && a.ProcessNo == processNo && b.To == workshopId && b.Type == DataRelationType.Process_To_WorkShop.ToString()).CountAsync()>0;
        }
        #endregion
    }
}
