...
namespace Meiam.System.Interfaces
{
    public class BaseProductLineService : BaseService<Base_ProductLine>, IBaseProductLineService
    {
        ...
        /// <param name="parm"></param>
        /// <returns></returns>
        public async Task< PagedInfo<ProductLineVM>> QueryLinePagesAsync(ProductLineQueryDto parm)
        {
            var source = Db.Queryable<Base_ProductLine, Sys_DataRelation, Base_ProductProcess, Sys_DataRelation, Base_WorkShop, Sys_DataRelation, Base_Factory>((a, b, c, d, e, f, g) => new object[] {
                JoinType.Inner,a.ID == b.Form,
                JoinType.Inner,b.To == c.ID,
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public async Task< ProductLineVM> GetLineAsync(string id)
        {
            var source = Db.Queryable<Base_ProductLine, Sys_DataRelation, Base_ProductProcess, Sys_DataRelation, Base_WorkShop, Sys_DataRelation, Base_Factory>((a, b, c, d, e, f, g) => new object[] {
                JoinType.Inner,a.ID == b.Form,
                JoinType.Inner,b.To == c.ID,
        ...
        /// </summary>
        /// <returns></returns>
        public async Task< List<ProductLineVM>> GetAllLineAsync(bool? enable = null)
        {
            var source = Db.Queryable<Base_ProductLine, Sys_DataRelation, Base_ProductProcess, Sys_DataRelation, Base_WorkShop, Sys_DataRelation, Base_Factory>((a, b, c, d, e, f, g) => new object[] {
                JoinType.Inner,a.ID == b.Form,
                JoinType.Inner,b.To == c.ID,
        ...
        /// <param name="processId"></param>
        /// <returns></returns>
        public async Task< bool> AnyAsync(string Id, string lineNo, string processId)
        {
            return await Db.Queryable<Base_ProductLine, Sys_DataRelation>((a, b) => new object[] {
                JoinType.Inner,a.ID == b.Form
            })
            .Where((a, b) => a.ID != Id && a.LineNo == lineNo && b.To == processId && b.Type == DataRelationType.Line_To_Process.ToString()).CountAsync()>0;
        }
        #endregion
