...
namespace Meiam.System.Interfaces
{
    public class BaseWorkShopService : BaseService<Base_WorkShop>, IBaseWorkShopService
    {
        ...
        /// <param name="parm"></param>
        /// <returns></returns>
        public async Task< PagedInfo<WorkShopVM>> QueryWorkShopPagesAsync(WorkShopQueryDto parm)
        {
            var source = Db.Queryable<Base_WorkShop, Sys_DataRelation, Base_Factory>((a, b, c) => new object[] {
                JoinType.Inner,a.ID == b.Form,
                JoinType.Inner,b.To == c.ID,
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public async Task< WorkShopVM> GetWorkShopAsync(string id)
        {
            var source = Db.Queryable<Base_WorkShop, Sys_DataRelation, Base_Factory>((a, b, c) => new object[] {
                JoinType.Inner,a.ID == b.Form,
                JoinType.Inner,b.To == c.ID,
        ...
        /// </summary>
        /// <returns></returns>
        public async Task< List<WorkShopVM>> GetAllWorkShopAsync(bool? enable = null)
        {
            var source = Db.Queryable<Base_WorkShop, Sys_DataRelation, Base_Factory>((a, b, c) => new object[] {
                JoinType.Inner,a.ID == b.Form,
                JoinType.Inner,b.To == c.ID,
        ...
        /// </summary>
        /// <returns></returns>
        public async Task< List<WorkShopVM>> GetAllWorkShopCacheAsync(bool useCache = false, int cacheSecond = 3600)
        {
            var source = Db.Queryable<Base_WorkShop, Sys_DataRelation, Base_Factory>((a, b, c) => new object[] {
                JoinType.Inner,a.ID == b.Form,
                JoinType.Inner,b.To == c.ID,
        ...
        /// <param name="factoryId"></param>
        /// <returns></returns>
        public async Task< bool> AnyAsync(string Id, string workShopNo, string factoryUID)
        {
            return await Db.Queryable<Base_WorkShop, Sys_DataRelation>((a, b) => new object[] {
                JoinType.Inner,a.ID == b.Form
            })
            .Where((a, b) => a.ID != Id && a.WorkShopNo == workShopNo && b.To == factoryUID && b.Type == DataRelationType.WorkShop_To_Factory.ToString()).CountAsync()>0;
        }
        #endregion
    }
}
